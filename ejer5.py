...
# En un entorno interactivo, aquí pediríamos al usuario que proporcione un número.
# En este entorno no interactivo, usamos 42 como un número de ejemplo.
numero_ejemplo = 42  # Este valor es solo para demostración.
